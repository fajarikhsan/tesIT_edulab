        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Fajar Ikhsan</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="<?= base_url('student'); ?>" class="nav-link <?= ($title == 'Data Murid') ? 'active' : '' ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Murid</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('statistics'); ?>" class="nav-link <?= ($title == 'Resume Statistik') ? 'active' : '' ?>">
                                <i class="far fa-circle nav-icon"></i>
