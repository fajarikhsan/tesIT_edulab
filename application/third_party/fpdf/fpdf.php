...
class FPDF
{
	...
	function Header()
	{
		...
		// Logo
		$this->Image(base_url('assets/img/logo.png'), 10, 15, 30);
		// Helvetica bold 15
		...
		$this->SetTopMargin(0);
		// Title
		$this->MultiCell(80, 10, 'PT Kreasi Edulab Indonesia', 0, 2);
		$this->Cell(40);
		$this->SetFont('Helvetica', '', 12);
		$this->MultiCell(60, 10, 'Jl. Kalimantan No. 7, Bandung edulab.indonesia@gmail.com 0813-6321-3988', 0, 2);
		// Line
		$this->Line(10, 55, 279.4 - 10, 55);
		// Line break
		$this->Ln(1);
	}
